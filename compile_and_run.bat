...
start cmd /k "echo PEEC compiling && g++ -o src/peer/peer.exe src/peer/peer.cpp src/peer/include/feature.cpp src/peer/include/request.cpp src/peer/include/command.cpp -lws2_32 && cd src\peer && .\peer.exe"
echo Peer started.
